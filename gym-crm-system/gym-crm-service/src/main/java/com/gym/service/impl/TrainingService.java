...
public class TrainingService extends AbstractService<Training, Long> {
    ...
    public TrainingService(ITrainingDao trainingDao, ITraineeDao traineeDao,
                           ITrainerDao trainerDao, ReportIntegrationService reportIntegrationService) {
        super(trainingDao);
        this.trainingDao = trainingDao;
        this.traineeDao = traineeDao;
        this.trainerDao = trainerDao;
        this.reportIntegrationService = reportIntegrationService;
    }
